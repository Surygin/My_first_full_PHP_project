<?php
    ...
    admin_or_not($_SESSION['user_role']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="query/create_user.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_job" id="simpleinput" class="form-control">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" name="user_phone" id="simpleinput" class="form-control">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" name="geo" id="simpleinput" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_email" id="simpleinput" class="form-control">
                                </div>

                                <!-- password -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Пароль</label>
                                    <input type="password" name="user_psw" id="simpleinput" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="user_avatar" id="example-fileinput" class="form-control-file">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="user_vk" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="user_tm" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" name="user_im" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
