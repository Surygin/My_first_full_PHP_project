                        ...
                        <div class="panel-container">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_name" id="simpleinput" class="form-control" value="<?php echo $user[0]['firstName']?>">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input type="text" name="user_job" id="simpleinput" class="form-control" value="<?php echo $user[0]['jobRole']?>">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" name="user_phone" id="simpleinput" class="form-control" value="<?php echo $user[0]['phone']?>">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" name="geo" id="simpleinput" class="form-control" value="<?php echo $user[0]['geo']?>">
                                </div>
