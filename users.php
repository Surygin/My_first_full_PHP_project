...
$role = get_role_user($user);
set_role_user($role);
$name = get_firstName_user($user);
...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <p class="nav-link">Привет <?php echo $name;?> !</p>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="query/logaut.php">Выйти</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="alert alert-<?php if(!$_SESSION['status']) { echo 'danger';} else { echo 'success'; };?> text-dark" role="alert">
                <strong>Уведомление!</strong> <?php echo $_SESSION['msg'];?>
            </div>
            <?php }
                unset($_SESSION['msg']);
            ?>
            ...
            <div class="row" id="js-contacts">
                ...
                ?>
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['firstName'] .' '. $user['lastName']?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                        <a href="page_profile.php?id=<?php echo $user['id']?>"><?php echo $user['firstName'] .' '. $user['lastName']?></a>
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php } else if ($user['id'] == $_SESSION['user_id']){?>
                                        <span>
                                            <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                            <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                        </span>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="query/user_delete.php?id=<?php echo $user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить
                                        </a>
                                    </div>
                                    <span class="text-truncate text-truncate-xl"><?php echo $user['jobRole']?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a href="mailto:<?php echo $user['mail']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?php echo $user['login']?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i><?php echo $user['geo']?></address>
                                <div class="d-flex flex-row">
                                    <a href="<?php echo $user['VKlink']?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="<?php echo $user['TMlink']?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?php echo $user['IMlink']?>" class="mr-2 fs-xxl" style="color:#E1306C">
