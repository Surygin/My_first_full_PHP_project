                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <?php }
                                        unset($_SESSION['msg']);
                                    ?>
                                    <form id="js-login" novalidate="" action="query/registration.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" name="psw" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
